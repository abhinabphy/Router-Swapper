...
function App() {
	 ...
	 const from="0xEeeeeEeeeEeEeeEeEeEeeEEEeeeeEeeeeeeeEEeE";//MATIC
...
if(window.ethereum) {
	...
	try {
	  ...
	  alert (provider1)
	  const provider2 = new ethers.providers.JsonRpcProvider("https://api.avax-test.network/ext/C/rpc",43113);
